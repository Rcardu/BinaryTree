...
vector<int>IterateTraversalOfBinaryTrees::IterateTraversalOfBinaryTrees_pro(BiTreeNode<int>*node){
...
vector<int>IterateTraversalOfBinaryTrees::IterateTraversalOfBinaryTrees_ins(BiTreeNode<int>*node){
    stack<BiTreeNode<int>*>st;
    vector<int>result;
...
vector<int>IterateTraversalOfBinaryTrees::IterateTraversalOfBinaryTrees_post(BiTreeNode<int>*node){
    stack<BiTreeNode<int>*>st;
    vector<int>result;
    if(node==NULL)return result;
    st.push(node);
