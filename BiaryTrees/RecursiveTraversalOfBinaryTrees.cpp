/*
 * @Author: ricardo gq1090523745@163.com
 * @Date: 2023-04-30 19:25:03
 * @LastEditors: Please set LastEditors
 * @LastEditTime: 2023-05-01 00:08:56
 * @FilePath: \BinaryTree\BiaryTrees\RecursiveTraversalOfBinaryTrees.cpp
...
void RecursiveTraversalOfBinaryTreesFormat(){
    ...
    //Bitree->insert_left(Bitree->root,data[0]);
    //Bitree->insert_left(Bitree->root,data[1]);
    //Bitree->insert_right(Bitree->root,data[2]);
